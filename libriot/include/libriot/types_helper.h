#ifndef LIBRIOT_TYPES_HELPER_H
#define LIBRIOT_TYPES_HELPER_H
...
riot_bin_node_type_str(enum riot_bin_node_type type) {
	switch (type) {
#define __TOKEN(x) case x: return #x;
		__TOKEN(RIOT_BIN_NODE_TYPE_NONE)
		__TOKEN(RIOT_BIN_NODE_TYPE_B8)
		__TOKEN(RIOT_BIN_NODE_TYPE_I8)
		__TOKEN(RIOT_BIN_NODE_TYPE_U8)
		__TOKEN(RIOT_BIN_NODE_TYPE_I16)
		__TOKEN(RIOT_BIN_NODE_TYPE_U16)
		__TOKEN(RIOT_BIN_NODE_TYPE_I32)
		__TOKEN(RIOT_BIN_NODE_TYPE_U32)
		__TOKEN(RIOT_BIN_NODE_TYPE_I64)
		__TOKEN(RIOT_BIN_NODE_TYPE_U64)
		__TOKEN(RIOT_BIN_NODE_TYPE_F32)
		__TOKEN(RIOT_BIN_NODE_TYPE_VEC2)
		__TOKEN(RIOT_BIN_NODE_TYPE_VEC3)
		__TOKEN(RIOT_BIN_NODE_TYPE_VEC4)
		__TOKEN(RIOT_BIN_NODE_TYPE_MAT4)
		__TOKEN(RIOT_BIN_NODE_TYPE_RGBA)
		__TOKEN(RIOT_BIN_NODE_TYPE_STR)
		__TOKEN(RIOT_BIN_NODE_TYPE_HASH)
		__TOKEN(RIOT_BIN_NODE_TYPE_FILE)
		__TOKEN(RIOT_BIN_NODE_TYPE_LIST)
		__TOKEN(RIOT_BIN_NODE_TYPE_LIST2)
		__TOKEN(RIOT_BIN_NODE_TYPE_PTR)
		__TOKEN(RIOT_BIN_NODE_TYPE_EMBED)
		__TOKEN(RIOT_BIN_NODE_TYPE_LINK)
		__TOKEN(RIOT_BIN_NODE_TYPE_OPTION)
		__TOKEN(RIOT_BIN_NODE_TYPE_MAP)
		__TOKEN(RIOT_BIN_NODE_TYPE_FLAG)
#undef __TOKEN
		default:			return NULL;
	}
}
...
riot_bin_node_type_from_raw(u8 raw) {
...
static inline u8
riot_bin_node_type_to_raw(enum riot_bin_node_type type) {
...
riot_bin_node_type_to_size(enum riot_bin_node_type type) {
	switch (type) {
		...
		case RIOT_BIN_NODE_TYPE_VEC2:	return sizeof(struct riot_vec2);
		case RIOT_BIN_NODE_TYPE_VEC3:	return sizeof(struct riot_vec3);
		case RIOT_BIN_NODE_TYPE_VEC4:	return sizeof(struct riot_vec4);
		case RIOT_BIN_NODE_TYPE_MAT4:	return sizeof(struct riot_mat4x4);
		case RIOT_BIN_NODE_TYPE_RGBA:	return sizeof(struct riot_rgba);
...
riot_bin_node_type_is_container(enum riot_bin_node_type type) {
	return type == RIOT_BIN_NODE_TYPE_LIST ||
		type == RIOT_BIN_NODE_TYPE_OPTION ||
